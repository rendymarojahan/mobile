...
appControllers.controller('noteListCtrl', function ($scope,$stateParams, $timeout,  $state) {
    ...
    $scope.initialForm = function () {
        ...
        $timeout(function () {
            ...
            if ($stateParams.product.pertemuan) {
                $scope.noteList = $stateParams.product.pertemuan;
            }else {
                $scope.noteList = 0;
            }
...
appControllers.controller('noteSettingCtrl', function ($scope, $state, $ionicViewSwitcher,$stateParams, $ionicHistory, $mdBottomSheet, $mdDialog, $mdToast) {
...
appControllers.controller('noteDetailCtrl', function ($scope,  $stateParams, $filter, $mdBottomSheet, $mdDialog, $mdToast, $ionicHistory) {
...
appControllers.controller('dealDetailCtrl', function ($scope,  $stateParams, $filter, $mdBottomSheet, $mdDialog, $mdToast, $ionicHistory) {
